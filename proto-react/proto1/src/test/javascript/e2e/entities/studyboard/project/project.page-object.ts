...
export class ProjectDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gatewayApp.studyboardProject.delete.question'));
...
export default class ProjectComponentsPage {
  ...
  async deleteProject() {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.studyboardProject.delete.question/);
