...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './xperm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_XPERM_LIST actions', async () => {
    ...
    it('dispatches FETCH_XPERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_XPERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_XPERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_XPERM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_XPERM actions', async () => {
      const expectedActions = [
        {
