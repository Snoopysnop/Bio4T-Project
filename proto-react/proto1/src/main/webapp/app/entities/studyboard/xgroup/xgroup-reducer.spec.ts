...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './xgroup.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_XGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_XGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_XGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_XGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_XGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_XGROUP actions', async () => {
      const expectedActions = [
        {
