...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './genolist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENOLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENOLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENOLIST actions', async () => {
      const expectedActions = [
        {
