...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPARISON_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPARISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPARISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPARISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPARISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPARISON actions', async () => {
      const expectedActions = [
        {
