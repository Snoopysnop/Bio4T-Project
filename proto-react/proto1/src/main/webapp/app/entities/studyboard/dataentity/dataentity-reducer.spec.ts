...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATAENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATAENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATAENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATAENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATAENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATAENTITY actions', async () => {
      const expectedActions = [
        {
