...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './b-dataref.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BDATAREF_LIST actions', async () => {
    ...
    it('dispatches FETCH_BDATAREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BDATAREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BDATAREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BDATAREF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BDATAREF actions', async () => {
      const expectedActions = [
        {
