...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dash.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DASH_LIST actions', async () => {
    ...
    it('dispatches FETCH_DASH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DASH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DASH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DASH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DASH actions', async () => {
      const expectedActions = [
        {
