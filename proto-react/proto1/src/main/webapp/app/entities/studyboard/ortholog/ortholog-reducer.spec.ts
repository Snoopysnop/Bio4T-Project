...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ortholog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORTHOLOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORTHOLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORTHOLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORTHOLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORTHOLOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORTHOLOG actions', async () => {
      const expectedActions = [
        {
