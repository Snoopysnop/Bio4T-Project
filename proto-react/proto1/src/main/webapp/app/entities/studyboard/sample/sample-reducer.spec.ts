...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sample.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMPLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SAMPLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SAMPLE actions', async () => {
      const expectedActions = [
        {
