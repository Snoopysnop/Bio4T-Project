...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './xuser.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_XUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_XUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_XUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_XUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_XUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_XUSER actions', async () => {
      const expectedActions = [
        {
